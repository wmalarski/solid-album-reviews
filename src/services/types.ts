...
export type RandomAlbumWithArtistFragment = {
	id?: number | null;
	sid?: string | null;
	title?: string | null;
	year?: number | null;
	artistByArtist?: { id: number; sid?: string | null; name: string } | null;
};
...
export type AlbumWithArtistFragment = {
	id: number;
	sid: string;
	title: string;
	year: number;
	artistByArtist: { id: number; sid?: string | null; name: string };
};

export type AlbumWithReviewsFragment = {
	id: number;
	sid: string;
	title: string;
	year: number;
	reviews: Array<{ id: number; rate: any; text: string; createdAt: any }>;
};
...
export type SelectAlbumsWithArtistQuery = {
	album: Array<{
		id: number;
		sid: string;
		title: string;
	...
	albumAggregate: { aggregate?: { count: number } | null };
};
...
export type SelectAlbumsWithReviewsQuery = {
	album: Array<{
		id: number;
		sid: string;
		title: string;
...
export type DeleteAlbumMutation = {
	deleteAlbum?: { returning: Array<{ artist: number }> } | null;
};
...
export type UpdateAlbumMutation = {
	updateAlbum?: { returning: Array<{ id: number }> } | null;
};
...
export type DeleteArtistMutation = {
	deleteArtist?: { returning: Array<{ id: number }> } | null;
};
...
export type UpdateArtistMutation = {
	updateArtist?: { returning: Array<{ id: number }> } | null;
};
...
export type ReviewWithAlbumAndArtistFragment = {
	id: number;
	rate: any;
	text: string;
	createdAt: any;
...
export type ReviewWithAlbumFragment = {
	id: number;
	rate: any;
	text: string;
	createdAt: any;
	albumByAlbum: { id: number; sid: string; title: string; year: number };
};
...
export type SelectReviewsQuery = {
	review: Array<{ id: number; rate: any; text: string; createdAt: any }>;
	reviewAggregate: { aggregate?: { count: number } | null };
};
...
export type SelectReviewsWithAlbumAndArtistQuery = {
	review: Array<{
		id: number;
		rate: any;
		text: string;
...
export type UpdateReviewMutation = {
	updateReview?: { returning: Array<{ id: number }> } | null;
};
...
export type DeleteReviewMutation = {
	deleteReview?: { returning: Array<{ album: number }> } | null;
};
...
export type SelectReviewsGridQuery = {
...
export function getSdk<C>(requester: Requester<C>) {
	return {
		RandomAlbums(
			...
			data?: RandomAlbumsQuery;
			errors?: Array<{ message: string; extensions?: unknown }>;
			extensions?: unknown;
		}> {
			return requester<RandomAlbumsQuery, RandomAlbumsQueryVariables>(
		...
		SelectAlbum(
			variables: SelectAlbumQueryVariables,
			options?: C,
		): Promise<{
			data?: SelectAlbumQuery;
			errors?: Array<{ message: string; extensions?: unknown }>;
			extensions?: unknown;
		}> {
			return requester<SelectAlbumQuery, SelectAlbumQueryVariables>(
				SelectAlbumDocument,
				variables,
				options,
			);
		},
		SelectAlbumsWithArtist(
			variables?: SelectAlbumsWithArtistQueryVariables,
			options?: C,
		): Promise<{
			data?: SelectAlbumsWithArtistQuery;
			errors?: Array<{ message: string; extensions?: unknown }>;
			extensions?: unknown;
		}> {
			return requester<
				SelectAlbumsWithArtistQuery,
				SelectAlbumsWithArtistQueryVariables
			>(SelectAlbumsWithArtistDocument, variables, options);
		},
		SelectAlbumsWithReviews(
			variables?: SelectAlbumsWithReviewsQueryVariables,
			options?: C,
		): Promise<{
			data?: SelectAlbumsWithReviewsQuery;
			errors?: Array<{ message: string; extensions?: unknown }>;
			extensions?: unknown;
		}> {
			return requester<
				SelectAlbumsWithReviewsQuery,
				SelectAlbumsWithReviewsQueryVariables
			>(SelectAlbumsWithReviewsDocument, variables, options);
		},
		DeleteAlbum(
			variables?: DeleteAlbumMutationVariables,
			options?: C,
		): Promise<{
			data?: DeleteAlbumMutation;
			errors?: Array<{ message: string; extensions?: unknown }>;
			extensions?: unknown;
		}> {
			return requester<DeleteAlbumMutation, DeleteAlbumMutationVariables>(
				DeleteAlbumDocument,
				variables,
				options,
			);
		...
		UpdateAlbum(
			...
			data?: UpdateAlbumMutation;
			errors?: Array<{ message: string; extensions?: unknown }>;
			extensions?: unknown;
		}> {
			return requester<UpdateAlbumMutation, UpdateAlbumMutationVariables>(
				UpdateAlbumDocument,
				variables,
				options,
			);
		...
		DeleteArtist(
			variables?: DeleteArtistMutationVariables,
			options?: C,
		): Promise<{
			data?: DeleteArtistMutation;
			errors?: Array<{ message: string; extensions?: unknown }>;
			extensions?: unknown;
		}> {
			return requester<DeleteArtistMutation, DeleteArtistMutationVariables>(
		...
		UpdateArtist(
			...
			data?: UpdateArtistMutation;
			errors?: Array<{ message: string; extensions?: unknown }>;
			extensions?: unknown;
		}> {
			return requester<UpdateArtistMutation, UpdateArtistMutationVariables>(
		...
		SelectReviews(
			variables?: SelectReviewsQueryVariables,
			options?: C,
		): Promise<{
			data?: SelectReviewsQuery;
			errors?: Array<{ message: string; extensions?: unknown }>;
			extensions?: unknown;
		}> {
			return requester<SelectReviewsQuery, SelectReviewsQueryVariables>(
				SelectReviewsDocument,
				variables,
				options,
			);
		},
		SelectReviewsWithAlbumAndArtist(
			variables?: SelectReviewsWithAlbumAndArtistQueryVariables,
			options?: C,
		): Promise<{
			data?: SelectReviewsWithAlbumAndArtistQuery;
			errors?: Array<{ message: string; extensions?: unknown }>;
			extensions?: unknown;
		}> {
			return requester<
				SelectReviewsWithAlbumAndArtistQuery,
				SelectReviewsWithAlbumAndArtistQueryVariables
			>(SelectReviewsWithAlbumAndArtistDocument, variables, options);
		},
		InsertReview(
			variables: InsertReviewMutationVariables,
			options?: C,
		): Promise<{
			data?: InsertReviewMutation;
			errors?: Array<{ message: string; extensions?: unknown }>;
			extensions?: unknown;
		}> {
			return requester<InsertReviewMutation, InsertReviewMutationVariables>(
		...
		UpdateReview(
			...
			data?: UpdateReviewMutation;
			errors?: Array<{ message: string; extensions?: unknown }>;
			extensions?: unknown;
		}> {
			return requester<UpdateReviewMutation, UpdateReviewMutationVariables>(
		...
		DeleteReview(
			...
			data?: DeleteReviewMutation;
			errors?: Array<{ message: string; extensions?: unknown }>;
			extensions?: unknown;
		}> {
			return requester<DeleteReviewMutation, DeleteReviewMutationVariables>(
		...
		SelectReviewsGrid(
			variables?: SelectReviewsGridQueryVariables,
			options?: C,
		): Promise<{
			data?: SelectReviewsGridQuery;
			errors?: Array<{ message: string; extensions?: unknown }>;
			extensions?: unknown;
		}> {
			return requester<SelectReviewsGridQuery, SelectReviewsGridQueryVariables>(
				SelectReviewsGridDocument,
				variables,
				options,
			);
		},
